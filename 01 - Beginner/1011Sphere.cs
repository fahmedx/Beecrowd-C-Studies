...
class URI{
    /*
        ...
        the volume of a sphere being provided the value of its radius (R) . 
        ...
        because some languages (including C++) assume that the division's result between 
        two integers is another integer. :)
    ...
    Output
        ...
        a space before and after the equal signal. 
